...
const catalog: CatalogItem[] = [
  ...
  },
  {
    ...
    description: (
      <>
        대폭발 이론(빅뱅 이론)에 따르면, 처음에 존재하는 에너지와 물질은 우주가 팽창함에 따라 밀도가 낮아졌다. 약 10
        <sup>-32</sup>초에 급팽창 시대라고 불리는 초기 가속 팽창, 그리고 알려진 네 가지 기본 힘의 분리 이후, 우주는 점차
        냉각되고 계속 팽창하여, 최초의 아원자 입자들과 단순한 원자들이 형성되었다. 암흑물질이 점차 모여서, 중력의
        영향아래 필라멘트들과 거시공동들의 한 거품-같은 구조를 형성했다. 수소와 헬륨으로 이루어진 거대한 구름들은 점차
        암흑 물질이 가장 고밀도인 장소들로 끌려가면서, 오늘날 볼 수 있는 최초의 은하들, 별들, 그리고 다른 모든 것들을
        형성했다.
      </>
    ),
  },
